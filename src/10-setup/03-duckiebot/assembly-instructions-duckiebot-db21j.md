...
- A plastic omnidirectional wheel instead of a metal one.

- A set of M3 nylon screws and nuts instead of metal ones.

Follow the instructions in this page, but:

- Replace steps 4 and 5 with the instructions in [](assembly-instructions-db21j-v3).
...
This section describes the steps to assemble the _camera assembly_.
...
This section describes the steps to assemble the _bottom assembly_.
...
This section describes the steps to assemble the _computation unit_.
...
This section describes the steps to assemble the _back assembly_.
...
This section describes the steps to assemble the _front assembly_.
...
This section describes the steps to assemble the _top assembly_.
...
This section describes the steps to assemble the _back pattern assembly_.
