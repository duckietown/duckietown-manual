```{seo}
:description: The Duckietown Archives are a private Stack Overflow space with technical questions and answers. This is the highest priority way to get support in Duckietown.
:keywords: Duckietown Archives, Duckietown Stack Overflow, how to join duckietown stack overflow
```

```{needget}
- [Join the Duckietown community on Slack](setup-account-slack)
---
- Access to the Duckietown Archives
```
