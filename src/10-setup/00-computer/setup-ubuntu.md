...
- It is __open source__, __free__, and __available worldwide__.
...
To install Ubuntu, follow this [Ubuntu Desktop installation tutorial](https://ubuntu.com/tutorials/install-ubuntu-desktop#2-download-an-ubuntu-image).
