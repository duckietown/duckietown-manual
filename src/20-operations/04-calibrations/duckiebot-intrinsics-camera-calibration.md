...
1. Move the calibration pattern in front of your Duckiebot's camera such that the __entire__ checkerboard pattern is within its field of view and colored lines begin to overlay the checkerboard pattern.
