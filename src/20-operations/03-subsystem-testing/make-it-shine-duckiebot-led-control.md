...
:name: fig:make-it-shine-duckiebot-led-control-leds-layout
:alt: Diagram of a Duckiebot with its front and rear LEDs identified.
...
LEDs are more than just lights. As actuators on a Duckiebot, they can serve several purposes:

- They indicate the mode or mission the Duckiebot is running.

- They communicate state changes in the controller.

- They signal upcoming turns or other navigational plans.

- They express character and personality.

- They light the driving environment.
...
{{ dt_duckietown_viewer_launch_tabs.format("LED Controller", "led_control") }}
