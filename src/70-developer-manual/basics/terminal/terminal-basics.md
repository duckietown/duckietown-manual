...
```{todo}
- Write a section on how to customize the terminal.

- Write a section on IDEs and provide a preset configuration for PyCharm Community Edition and Visual Studio.

- Provide best practices for development.

- Consider moving this section out of the developer manual because it is too basic.
```
