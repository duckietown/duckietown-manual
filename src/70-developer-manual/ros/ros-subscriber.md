...
---
- Learn how to create a new __ROS Node__ receiving messages using a __ROS Subscriber__.
```
...
In this section, we will learn to create a __ROS Subscriber__.

The general concept is simple: a subscriber has the job of listening for messages about a specific _topic_
that are published by other ROS nodes (using __ROS Publishers__) over a ROS network.
