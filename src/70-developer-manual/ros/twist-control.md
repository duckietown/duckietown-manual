...
---
- Learn how to control the Duckiebot’s chassis linear and angular velocities using a __ROS Publisher__.
```
...
The message type is __duckietown_msgs/Twist2DStamped__, with fields:
...
__duckietown_msgs/Twist2DStamped__ which contains the following fields.
