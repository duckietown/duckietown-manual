(slides-and-recordings-tools-ros)=
# Middlewares and the Robot Operating System (ROS)

```{seo}
:description: ROS (Robot operating system) is a well known middleware, i.e., a "postman" that carries data around the robot architecture.
...
```{slides} ../../../../_assets/instructor-manual/middlewares.pdf
