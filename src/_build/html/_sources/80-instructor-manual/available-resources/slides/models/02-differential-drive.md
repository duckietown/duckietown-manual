```{seo}
:description: The differential drive model explained step-by-step, useful for Duckiebot robots in Duckietown.
:keywords: mathematical modeling, differential drive, duckietown, robot, mobile robot
```

(slides-and-recordings-models-differential-drive)=
...
```{vimeo} 587974152
:alt: Modeling a Differential Drive Robot
```
