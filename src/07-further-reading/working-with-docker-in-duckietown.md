...
* - Using containers
  - Using VMs
* - ![alt-text](../_images/further_reading/working-with-docker/docker-containerVM.png)
  - ![alt-text](../_images/further_reading/working-with-docker/docker-containerVM2.png)
```
