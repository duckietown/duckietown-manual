...
The documentation is divided into __books__, __parts__ (labeled `part:`), __chapters__ (labeled `chapter:`), and __sections__ (labeled `sec:`).
...
- Avoid __ALL CAPS__ for emphasis; retain established acronyms, commands, and identifiers.

- Use __bold text__ sparingly.
