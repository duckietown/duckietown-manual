...
7. Run `dts duckiebot battery upgrade DUCKIEBOT_NAME` and follow the instructions. If prompted to "double-click" the Duckiebattery's button, _quickly_ press the Duckiebattery's button __twice__.

8. (Optional) If the display shows "NoBT", press the Duckiebattery's button __once__ and reboot your Duckiebot.
...
Otherwise, if the output of the step 7 is any other error message, press the Duckiebattery's button __once__, reboot your Duckiebot and try again.
````
