...
:class: tip
1. Check the troubleshooting section at the end of each instruction manual page (when applicable)

2. Check the [Duckietown Archives](https://stackoverflowteams.com/c/duckietown/questions) if your problem has already been solved ([How to sign up to the Duckietown Archives](setup-account-stack-overflow))

3. Create a post on the Duckietown Archives

4. Search [the Duckietown community](https://duckietown.slack.com/) ([Join the Duckietown Community on Slack](setup-account-slack))

5. Link your Duckietown Archives question to the appropriate #help channel.
```

When asking for help, make sure to provide sufficient information for others to reproduce your error. Specifically, provide:

- The OS you are using.

- The instructions you are following.
