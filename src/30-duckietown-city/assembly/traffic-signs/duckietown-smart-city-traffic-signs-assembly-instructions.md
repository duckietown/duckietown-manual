...
The full set of currently existing signs is available in the [signs-and-tags repository](https://github.com/duckietown/signs-and-tags).
...
:alt: Laser-cut components included in a Duckietown traffic sign stand kit.
...
:alt: Assembled wooden Duckietown traffic sign stand.
...
:alt: Duckietown traffic sign mounted on an assembled wooden stand.
