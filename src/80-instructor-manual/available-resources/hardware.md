...
Also, for complete detail about the components of the Duckiebot, as well as its operation, refer to the [Duckiebot Operation Manual](book-db-opmanual).
...
The environment is very tightly specified. For full details, visit the [Duckietown Operation Manual](book-opmanual-duckietown:book). 
...
For full details on the platform, visit the [Duckiedrone Operation Manual](book-opmanual-duckiedrone:opmanual-dd24-book). 
