...
Ideally, we would be able to provide some kind of formal guarantee about the performance so that legislators and other stakeholders can _trust_ the technology and move to regulate it.
...
```{slides} ../../../../_assets/instructor-manual/safety-formal-methods.pdf
```
