```{seo}
:description: Deriving the odometry of a mobile robot (Duckiebot) using wheel encoder data in Duckietown.
:keywords: odometry, wheel encoders, differential drive, robot, mobile robot, autonomous vehicle, autonomy, mathematical model, dead-reckogning, path estimation
```

(slides-and-recordings-control-odometry)=
# Odometry
