```{seo}
:description: Control systems for autonomous mobile robots applied in Duckietown.
:keywords: controls, control systems, odometry, pid, pid controller, duckietown, proportional integrative derivative, self-driving cars, AVs, mobile robot control, pure pursuit
```
