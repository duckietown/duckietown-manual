```{seo}
:description: Full-length lecture on modeling in Duckietown
:keywords: kinematics, dynamics, duckietown
```

(slides-and-recordings-models-full-lecture)=
...
```{slides} ../../../../_assets/instructor-manual/modeling.pdf
```
