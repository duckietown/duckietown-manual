...
Unfortunately, in practice, it is almost always impossible to compute. 

Notwithstanding, this filter forms the basis for introducing several other filter families which make different assumptions to make the computation of the posterior more efficient. 
