...
Note there is also a notebook activity that explains this approach in more detail in [the state estimation exercise](mooc-exercises). 

```{vimeo} 589420968
:alt: Particle Filter
```

```{slides} ../../../../_assets/instructor-manual/particle-filter.pdf
```
