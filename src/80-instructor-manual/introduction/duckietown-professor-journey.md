```{seo}
:description: Guide for Professors. How to use Duckietown in universities for teaching, doing research and outreach.
:keywords: higher eduction, robotics, AI, robot autonomy, professor journey, training, teaching, research
```

(professor-journey)=
# The Professor's journey

Duckietown was designed with multiple objectives in mind: to help professors deliver great classes, [publish compelling papers](https://scholar.google.ca/scholar?cites=2722597216448332555&as_sdt=2005&sciodt=0,5&hl=en), and engage their communities.
...
(professor-journey-getting-started)=
...
Students learn best by doing. Organize students in the class in groups and propose projects for them to develop new autonomous behaviors, or expand upon existing ones. Assign each group a _mentor_, such as a Ph.D. student or postdoc, for best results.
...
2. Have the opportunity, by excelling in the class, to get much more than just a good grade for the class. For example, particularly successful projects could result in co-authorship in publications (led by your Ph.D. students and/or Postdocs).

### Peer review and community engagement

Although we understand that grades are necessary, there are many ways to assess the [learning outcomes](considerations-ilo) of your students.
...
- Forcing students to _show_ their results working in the real world and explaining successes and failures to a less prepared audience is a great learning experience in itself;
...
There are several dimensions in which this expansion can happen:

- You can increase the number of vehicles.

- You can add vehicle types, such as self-driving cars, quadcopters, and smart city infrastructure.

- You can increase the size and complexity of the city topography.
