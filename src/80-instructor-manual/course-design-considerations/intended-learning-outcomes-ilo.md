...
By the end of the course, students can use operational tools to:
 ...
 - Use standard tools for software development (e.g., source code
...
- Utilize the best practices of system development, including test-driven
...
(consideration-ilo-academic)=
## Mastery of Theory

Demonstrate, through the completion of learning experiences that are implemented both in simulation and on physical robot hardware, an understanding of theory related to:
...
(consideration-ilo-communication)=
