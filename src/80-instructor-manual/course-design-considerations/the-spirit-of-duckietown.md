...
The best engineers and scientists are the ones who have solid theoretical foundations,
as well as practical experience in the domain of interest.

In autonomous robotics, it is important to get the "feeling" of what makes a robot work, and how the success or failure depends on subtle interaction
...
Whenever possible, we try to end the course with a __public__ demonstration. This has many potential benefits:

1. It acts as a strong motivation for students to produce something that they are proud to show the world.
...
3. The pressure of the demo is an essential aspect of robotics - it is possible to make something work _once_ and produce a video, but doing a public demonstration requires ensuring that it works _reliably every time_.
...
Sometimes we go as far as creating a story for them, inspired by the [Hero's Journey](https://en.wikipedia.org/wiki/Hero%27s_journey):
...
```{admonition} The Duckietown Learning Journey
