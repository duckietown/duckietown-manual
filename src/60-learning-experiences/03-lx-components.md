...
The code placed inside this folder can then be imported in the notebooks for visualization and testing, or automatically compiled and configured to be deployed as an __agent__ on Duckietown robots (Duckiebot, Duckiedrones) - both physical and virtual. Code is built using the `dts code build` function:
