...
1. __Create a fork__: Navigate to the repository of interest, for example: [the Braitenberg vehicles repository](https://github.com/duckietown/lx-braitenberg). All LXs URLs have the same format: `https://github.com/duckietown/lx-<lx-name>`
...
2. __Clone the fork__: clone the fork on your computer, replacing your GitHub username in the command below, and navigate to the new folder:
...
3. __Configure upstream repo__: configure the Duckietown version of this repository as the upstream repository to synchronize with your fork.
...
```{include} ../_includes/lx/matrix-target-note.md
```
...
```{include} ../_includes/lx/code-project-metadata-trouble.md
```

```{include} ../_includes/lx/code-editor-no-project-trouble.md
```
